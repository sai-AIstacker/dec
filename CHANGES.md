...
- Fix PHP8.5 deprecated using null as an array offset, use an empty string instead in DBGet.fnc.php, Inputs.php, MenuReports.php, ActivityReport.php, EditReportCardGrades.php, AccessLog.php & `_makeLetterGrade.fnc.php`
