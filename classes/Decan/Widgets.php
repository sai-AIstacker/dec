...
class Widgets
{
	...
	/**
	 * Build Widget
	 * Calls the all() method or the \Decan\Widget\[Name] class.
	 *
	 ...
	 */
	function build( $name, $class_prefix = '\Decan\Widget\\' )
	{
	...
	function custom( $extra_widgets, $class_prefix = 'Widget\\' )
	{
		foreach ( $extra_widgets as $add_on => $widgets )
		{
			...
			foreach ( $widgets as $widget )
			{
				 ...
				 * Custom '\Addon_Name\Widget' class prefix.
				 *
				 * @example namespace Hostel_Premium\Widget; class HostelRoom implements \Decan\Widget {...}
				 */
